...
def main():
    ...
    pygame.display.set_caption('The Ultimate Sudoku Game')
    icon = pygame.image.load('assets/newthumbnail.png')
    pygame.display.set_icon(icon)

    font = pygame.font.SysFont('Bahnschrift', 40)
    text = font.render('Starting', True, (0, 0, 0))
    screen.blit(text, (175, 245))

    font = pygame.font.SysFont('Bahnschrift', 40)
    text = font.render('the Game', True, (0, 0, 0))
